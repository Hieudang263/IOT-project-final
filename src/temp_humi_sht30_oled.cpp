...
void initTempHumiSht30Oled() {
  ...
  Serial.println("✅ Temp/Humidity SHT30 OLED initialized");
}


// =========================== FREERTOS TASK ===========================
void temp_humi_sht30_oled(void *parameter) {
  // Initialize once at task start
  initTempHumiSht30Oled();
  ...
  display.display();
  vTaskDelay(50 / portTICK_PERIOD_MS);  // Use vTaskDelay instead of delay() in FreeRTOS task
  }
}
